...
let TicketsService = class TicketsService {
    ...
    async getTicketsStates() {
        try {
            console.log(...oo_oo(`2044893209_252_6_252_26_4`, `Fahd `));
            const totalTickets = await this.ticketModel.countDocuments({});
            console.log(...oo_oo(`2044893209_254_6_254_65_4`, `Total tickets in collection: ${totalTickets}`));
            const sampleDocs = await this.ticketModel
                .find({ status: { $exists: true } })
                .limit(5);
            console.log(...oo_oo(`2044893209_260_6_260_62_4`, "Sample documents with status:", sampleDocs));
            const result = await this.ticketModel
                ...
                .exec();
            console.log(...oo_oo(`2044893209_286_6_286_48_4`, "Aggregation result:", result));
            ...
            console.error(...oo_tx(`2044893209_292_6_292_56_11`, "Error in getTicketsStates:", error));
    ...
    async getTicketsStatusSummary() {
        try {
            ...
            console.error(...oo_tx(`2044893209_346_4_346_61_11`, 'Error in getTicketsStatusSummary:', error));
